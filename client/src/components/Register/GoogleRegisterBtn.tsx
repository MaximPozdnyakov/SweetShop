...
class GoogleRegisterBtn extends React.Component {
    handleGoogleRegister = (e: React.MouseEvent<HTMLButtonElement>) => {
        e.preventDefault();
        window.location.href = `${window.location.origin}/api/google-auth`;
    };
